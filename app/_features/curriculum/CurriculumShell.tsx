...
export function CurriculumShell({
  ...
  const displayName = storedUser?.full_name || "Admin";
  const displayProfileImage = storedUser?.profile_image_url ?? null;
          ...
          <nav className="mt-10 space-y-2">
            ...
            <div>
              ...
              >
                ...
                Curriculum
                <span
                  className={`ml-auto flex h-5 w-5 items-center justify-center text-[#7da6e6] transition-transform ${
